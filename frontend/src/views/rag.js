...
function ContactUs() {
    ...
    useEffect(() => {
        ...
        const ws = new WebSocket('ws://judgementgame-v2-backend.onrender.com/ws'); // Ensure this is the correct URL for your WebSocket connection
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('https://judgementgame-v2-backend.onrender.com/process-filings/', {
                method: 'POST',
